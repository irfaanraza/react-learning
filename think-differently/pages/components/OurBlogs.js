                  ...
                  <div className='container'>
                        <Row gutter={10}>
                              ...
                              <Col xs={24} sm={24} md={8} lg={8} xl={8}>
                                    ...
                                    <h2>Turning Around the Fontera Disaster</h2>
                                    <p>
                                          A topic close to my heart. Infact It
                                          should be close to all our
                                          hearts.Lorem ipsum dolor sit amet
                                          ...
                                          harum quisquam eius sed odit fugiat
                                          iusto fuga praesentium optio, eaque
                                          rerum! Provident similique accusantium
                                          nemo autem. Veritatis obcaecati
